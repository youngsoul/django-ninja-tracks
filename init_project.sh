docker-compose build django-web-service
...
#docker-compose exec django-web-service python manage.py migrate
#docker-compose exec django-web-service python manage.py createsuperuser
